 ...
 * Why
 * ---
 * wuiSmarty is a way to create DOM elements based on data. wuiSmarty should be considered a
 ...
 * - Inability to "compile" the template - a 2X speed improvement in wuiSmarty
 *
 * Syntax
 * ------
 * wuiSmarty syntactically follows the familiar usage of placing variables in the template
 ...
 *
 * wuiSmarty will "compile" its template on the first run, meaning rather than parsing the template
 ...
 *                                          string.
 *
 * @returns {Object}    The wuiSmarty object is returned.
 */
const wuiSmarty = function(configs) {
    $.extend(this, {
        html:       ''
    }, configs, {
        compiled:   null,
